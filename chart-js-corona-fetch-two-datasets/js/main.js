...
function prepareData(data) {
  ...
  for (const object of data) {
    ...
    currentlyInfected.push(object.numberOfCurrentlyInfected);
  }
  ...
  let chart = new Chart(chartContainer, {
    ...
    data: {
      ...
      datasets: [{
        ...
        data: data.currentlyInfected, // refering to the data object, holding data from prepareData()
        label: 'Number of currently Infected',
        backgroundColor: '#f49fb6', // Customise the graf color etc. Go to the docs to find more: https://www.chartjs.org/docs/latest/
        borderColor: '#f4d2d2'
      }]
    },
